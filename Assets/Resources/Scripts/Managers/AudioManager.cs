...
{
    [Header("Bgm 플레이 여부(안씀)")]
    public bool isPlayBgm = true;
    [Header("Sfx 플레이 여부(안씀)")]
    ...
    public enum Sfx
    {
        PowerUp, RankUp, Damage, Heal, Door, Paper, Broken, TimeOver, Summon, Block, Warn, Typing, Wind, Arrow, Slash, Ink,
        Portal
    }
